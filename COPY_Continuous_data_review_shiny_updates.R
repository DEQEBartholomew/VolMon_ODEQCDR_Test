...
setwd("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC B")

xlsx_input <- "WorkingCopy_MFIMW_NFJDWC.B_w_results.xlsx"

output_dir <-"//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC B/R"

xlsx_pre_check_output <- "IMW NFJDWC B_PRECHECK.xlsx"
shiny_output <- "IMW NFJDWC B_SHINY_CDR.Rdata"
xlsx_output <- "IMW NFJDWC B_output.xlsx"

#changelog output
changelog <-  'IMW NFJDWC B_changelog'


source("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC B/R/R Scripts/cols_audit_volmon.R")
source("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC B/R/R Scripts/cols_deploy_volmon.R")
source("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC B/R/R Scripts/cols_deploy_volmon_export.R")
source("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC B/R/R Scripts/cols_deploy_volmon_forexport.R")
source("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC B/R/R Scripts/cols_prepost_volmon.R")
source("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC B/R/R Scripts/cols_projects_volmon.R")
source("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC B/R/R Scripts/contin_export_volmon_v2_1.R")
source("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC B/R/R Scripts/contin_import_volmon_v2.R")
source("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC B/R/R Scripts/mloc_col_names_volmon.R")
source("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC B/R/R Scripts/update_deploy_volmon.R")
...
result_review <- bind_rows(
  ...
  tibble(
    revision_id     = "[42207-ORDEQ - 2045433 - Temperature, water]: 50959:56303",
    rds_rows        = list(c(50959:56042)),
    xlsx_rows       = "50959:56042",
    new_qualifier   = "E",
    review_comment  = "Data of unknown quality. No audits",
    processing_note = "No audits included with submission",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42207-ORDEQ - 2045433 - Temperature, water]: 50959:56303",
    rds_rows        = list(c(56043:56303)),
    xlsx_rows       = "56043:56303",
    new_qualifier   = "C",
    review_comment  = "Logger likely out of water",
    processing_note = "Dramatic shift in temperature at the end of deployment. Logger likely retrieved earlier than recorded",
    reviewer        = analyst,
    review_datetime = with_tz(Sys.time(), tzone = "America/Los_Angeles")),
  
  
  tibble(
    revision_id     = "[42203-ORDEQ - 2045442 - Temperature, water]: 56304:62008",
    rds_rows        = list(c(56304:61843)),
    xlsx_rows       = "56304:61843",
    new_qualifier   = "E",
    review_comment  = "Data of unknown quality. No audits",
    processing_note = "No audits included with submission",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42203-ORDEQ - 2045442 - Temperature, water]: 56304:62008",
    rds_rows        = list(c(61844:62008)),
    xlsx_rows       = "61844:62008",
    new_qualifier   = "C",
    review_comment  = "Logger likely out of water",
    processing_note = "Dramatic shift in temperature at the end of deployment. Logger likely retrieved earlier than recorded",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42206-ORDEQ - 2242608 - Temperature, water]: 62009:67353",
    rds_rows        = list(c(62009:67092)),
    xlsx_rows       = "62009:67092",
    new_qualifier   = "E",
    review_comment  = "Data of unknown quality. No audits",
    processing_note = "No audits included with submission",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42206-ORDEQ - 2242608 - Temperature, water]: 62009:67353",
    rds_rows        = list(c(67093:67353)),
    xlsx_rows       = "67093:67353",
    new_qualifier   = "C",
    review_comment  = "Logger likely out of water",
    processing_note = "Dramatic shift in temperature at the end of deployment. Logger likely retrieved earlier than recorded",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42215-ORDEQ - 2331400 - Temperature, water]: 67354:71499",
    rds_rows        = list(c(67354:71240)),
    xlsx_rows       = "67354:71240",
    new_qualifier   = "E",
    review_comment  = "Data of unknown quality. No audits",
    processing_note = "No audits included with submission",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42215-ORDEQ - 2331400 - Temperature, water]: 67354:71499",
    rds_rows        = list(c(71241:71499)),
    xlsx_rows       = "71241:71499",
    new_qualifier   = "C",
    review_comment  = "Logger likely out of water",
    processing_note = "Dramatic shift in temperature at the end of deployment. Logger likely retrieved earlier than recorded",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42204-ORDEQ - 2331404 - Temperature, water]: 71500:77204",
    rds_rows        = list(c(71500:77039)),
    xlsx_rows       = "71500:77039",
    new_qualifier   = "E",
    review_comment  = "Data of unknown quality. No audits",
    processing_note = "No audits included with submission",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42204-ORDEQ - 2331404 - Temperature, water]: 71500:77204",
    rds_rows        = list(c(77040:77204)),
    xlsx_rows       = "77040:77204",
    new_qualifier   = "C",
    review_comment  = "Logger likely out of water",
    processing_note = "Dramatic shift in temperature at the end of deployment. Logger likely retrieved earlier than recorded",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42217-ORDEQ - 9711409 - Temperature, water]: 77205:82141",
    rds_rows        = list(c(77205:81882)),
    xlsx_rows       = "77205:81882",
    new_qualifier   = "E",
    review_comment  = "Data of unknown quality. No audits",
    processing_note = "No audits included with submission",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42217-ORDEQ - 9711409 - Temperature, water]: 77205:82141",
    rds_rows        = list(c(81883:82141)),
    xlsx_rows       = "81883:82141",
    new_qualifier   = "C",
    review_comment  = "Logger likely out of water",
    processing_note = "Dramatic shift in temperature at the end of deployment. Logger likely retrieved earlier than recorded",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42216-ORDEQ - 9801285 - Temperature, water]: 82142:87846",
    rds_rows        = list(c(82142:87588)),
    xlsx_rows       = "82142:87588",
    new_qualifier   = "E",
    review_comment  = "Data of unknown quality. No audits",
    processing_note = "No audits included with submission",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42216-ORDEQ - 9801285 - Temperature, water]: 82142:87846",
    rds_rows        = list(c(87589:87846)),
    xlsx_rows       = "87589:87846",
    new_qualifier   = "C",
    review_comment  = "Logger likely out of water",
    processing_note = "Dramatic shift in temperature at the end of deployment. Logger likely retrieved earlier than recorded",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42213-ORDEQ - 9903521 - Temperature, water]: 87847:92886",
    rds_rows        = list(c(87847:92886)),
    xlsx_rows       = "87847:92886",
    new_qualifier   = "E",
    review_comment  = "Data of unknown quality. No audits",
    processing_note = "No audits included with submission",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42213-ORDEQ - 9903521 - Temperature, water]: 87847:92886",
    rds_rows        = list(c(89191:89514)),
    xlsx_rows       = "89191:89514",
    new_qualifier   = "C",
    review_comment  = "Suspect data shift. Logger likely out of water",
    processing_note = "Suspect data",
    reviewer        = analyst,
    review_datetime = with_tz(Sys.time(), tzone = "America/Los_Angeles")),
  
  
  tibble(
    revision_id     = "[42212-ORDEQ - 10332710 - Temperature, water]: 1:5321",
    rds_rows        = list(c(1:5040)),
    xlsx_rows       = "1:5040",
    new_qualifier   = "E",
    review_comment  = "Data of unknown quality. No audits",
    processing_note = "No audits included with submission",
  ...
  tibble(
    revision_id     = "[42220-ORDEQ - 10332718 - Temperature, water]: 5322:10499",
    rds_rows        = list(c(5322:10479)),
    xlsx_rows       = "5322:10479",
    new_qualifier   = "E",
    review_comment  = "Data of unknown quality. No audits",
    processing_note = "No audits included with submission",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42220-ORDEQ - 10332718 - Temperature, water]: 5322:10499",
    rds_rows        = list(c(10480:10499)),
    xlsx_rows       = "10480:10499",
    new_qualifier   = "C",
    review_comment  = "Logger likely out of water",
    processing_note = "Dramatic shift in temperature at the end of deployment. Logger likely retrieved earlier than recorded",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42222-ORDEQ - 10332720 - Temperature, water]: 10500:15293",
    rds_rows        = list(c(10500:15149)),
    xlsx_rows       = "10500:15149",
    new_qualifier   = "E",
    review_comment  = "Data of unknown quality. No audits",
    processing_note = "No audits included with submission",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42222-ORDEQ - 10332720 - Temperature, water]: 10500:15293",
    rds_rows        = list(c(15150:15293)),
    xlsx_rows       = "15150:15293",
    new_qualifier   = "C",
    review_comment  = "Logger likely out of water",
    processing_note = "Dramatic shift in temperature at the end of deployment. Logger likely retrieved earlier than recorded",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42218-ORDEQ - 10629341 - Temperature, water]: 15294:20230",
    rds_rows        = list(c(15294:19971)),
    xlsx_rows       = "15294:19971",
    new_qualifier   = "E",
    review_comment  = "Data of unknown quality. No audits",
    processing_note = "No audits included with submission",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42218-ORDEQ - 10629341 - Temperature, water]: 15294:20230",
    rds_rows        = list(c(19972:20230)),
    xlsx_rows       = "19972:20230",
    new_qualifier   = "C",
    review_comment  = "Logger likely out of water",
    processing_note = "Dramatic shift in temperature at the end of deployment. Logger likely retrieved earlier than recorded",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42202-ORDEQ - 10629342 - Temperature, water]: 92887:98231",
    rds_rows        = list(c(98068:98231)),
    xlsx_rows       = "98068:98231",
    new_qualifier   = "C",
    review_comment  = "Logger likely out of water",
    processing_note = "Dramatic shift in temperature at the end of deployment. Logger likely retrieved earlier than recorded",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42214-ORDEQ - 10629345 - Temperature, water]: 20231:25024",
    rds_rows        = list(c(20231:24881)),
    xlsx_rows       = "20231:24881",
    new_qualifier   = "E",
    review_comment  = "Data of unknown quality. No audits",
    processing_note = "No audits included with submission",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42214-ORDEQ - 10629345 - Temperature, water]: 20231:25024",
    rds_rows        = list(c(24882:25024)),
    xlsx_rows       = "24882:25024",
    new_qualifier   = "C",
    review_comment  = "Logger likely out of water",
    processing_note = "Dramatic shift in temperature at the end of deployment. Logger likely retrieved earlier than recorded",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42224-ORDEQ - 10629346 - Temperature, water]: 25025:303694",
    rds_rows        = list(c(25025:30205)),
    xlsx_rows       = "25025:30205",
    new_qualifier   = "E",
    review_comment  = "Data of unknown quality. No audits",
    processing_note = "No audits included with submission",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42224-ORDEQ - 10629346 - Temperature, water]: 25025:30369",
    rds_rows        = list(c(30206:30369)),
    xlsx_rows       = "30206:30369",
    new_qualifier   = "C",
    review_comment  = "Logger likely out of water",
    processing_note = "Dramatic shift in temperature at the end of deployment. Logger likely retrieved earlier than recorded",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42211-ORDEQ - 10753851 - Temperature, water]: 30370:35690",
    rds_rows        = list(c(30370:35409)),
    xlsx_rows       = "30370:35409",
    new_qualifier   = "E",
    review_comment  = "Data of unknown quality. No audits",
    processing_note = "No audits included with submission",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42211-ORDEQ - 10753851 - Temperature, water]: 30370:35690",
    rds_rows        = list(c(35410:35690)),
    xlsx_rows       = "35410:35690",
    new_qualifier   = "C",
    review_comment  = "Logger likely out of water",
    processing_note = "Dramatic shift in temperature at the end of deployment. Logger likely retrieved earlier than recorded",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[MFJD_a12MileCr_Plemmons - 20066293 - Temperature, water]: 35691:40484",
    rds_rows        = list(c(35691:40340)),
    xlsx_rows       = "35691:40340",
    new_qualifier   = "E",
    review_comment  = "Data of unknown quality. No audits",
    processing_note = "No audits included with submission",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[MFJD_a12MileCr_Plemmons - 20066293 - Temperature, water]: 35691:40484",
    rds_rows        = list(c(40341:40484)),
    xlsx_rows       = "40341:40484",
    new_qualifier   = "C",
    review_comment  = "Logger likely out of water",
    processing_note = "Dramatic shift in temperature at the end of deployment. Logger likely retrieved earlier than recorded",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42209-ORDEQ - 20066298 - Temperature, water]: 40485:45253",
    rds_rows        = list(c(40485:44991)),
    xlsx_rows       = "40485:44991",
    new_qualifier   = "E",
    review_comment  = "Data of unknown quality. No audits",
    processing_note = "No audits included with submission",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42209-ORDEQ - 20066298 - Temperature, water]: 40485:45253",
    rds_rows        = list(c(44992:45253)),
    xlsx_rows       = "44992:45253",
    new_qualifier   = "C",
    review_comment  = "Logger likely out of water",
    processing_note = "Dramatic shift in temperature at the end of deployment. Logger likely retrieved earlier than recorded",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42210-ORDEQ - 20066300 - Temperature, water]: 45254:50958",
    rds_rows        = list(c(45254:50793)),
    xlsx_rows       = "45254:50793",
    new_qualifier   = "E",
    review_comment  = "Data of unknown quality. No audits",
    processing_note = "No audits included with submission",
    reviewer        = analyst,
  ...
  tibble(
    revision_id     = "[42210-ORDEQ - 20066300 - Temperature, water]: 45254:50958",
    rds_rows        = list(c(50794:50958)),
    xlsx_rows       = "50794:50958",
    new_qualifier   = "C",
    review_comment  = "Logger likely out of water",
    processing_note = "Dramatic shift in temperature at the end of deployment. Logger likely retrieved earlier than recorded",
    reviewer        = analyst,
...
differences <- compareDF::compare_df(df6.results, df5.results, group_col = "row.results") #LB added 6/16. Troubleshooting different column issue 
