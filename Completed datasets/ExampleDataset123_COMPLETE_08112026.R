...
setwd("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC E/R")

xlsx_input <- "WorkingCopy_MFIMW_NFJDWC.E_w_results.xlsx"


output_dir <-"//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC E/R/Output"

xlsx_pre_check_output <- "NFJDWC.E_PRECHECK.xlsx"
shiny_output <- "NFJDWC.E_SHINY_CDR.Rdata"
xlsx_output <- "NFJDWC.E_output.xlsx"

#changelog output
changelog <-  'NFJDWC.E_changelog'

source("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC E/R/R Scripts/cols_audit_volmon.R")
source("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC E/R/R Scripts/cols_deploy_volmon.R")
source("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC E/R/R Scripts/cols_deploy_volmon_export.R")
source("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC E/R/R Scripts/cols_deploy_volmon_forexport.R")
source("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC E/R/R Scripts/cols_prepost_volmon.R")
source("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC E/R/R Scripts/cols_projects_volmon.R")
source("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC E/R/R Scripts/contin_export_volmon_v2_1.R")
source("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC E/R/R Scripts/contin_import_volmon_v2.R")
source("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC E/R/R Scripts/mloc_col_names_volmon.R")
source("//deqlab1/Vol_Data/North Fork John Day/2020-2021/IMW NFJDWC/IMW NFJDWC Originals/IMW NFJDWC E/R/R Scripts/update_deploy_volmon.R")
...
df5.results <- df4.results %>%
  ...
  #'[42210-ORDEQ - 9711409 - Temperature, water]: 452711:485011
  #LB Missing post check and missing deployment audit. According to grading matrix this still can be B data. 
  odeqcdr::dql_update(rows = c(484907:484910), "C", "Anomolous datapoint, logger likely out of water") %>%  #LB
  
  
  #'[42241-ORDEQ - 9801283 - Temperature, water]: 485012:517933
  #LB missing post audit and deployment audit. 
  odeqcdr::dql_update(rows = c(515872), "C", "Erroneous datapoint")%>%  #LB
  
  
  #'[42217-ORDEQ - 9801285 - Temperature, water]: 517934:548672
  #LB shiny having difficulty zooming in because of dataset size. Missing deployment audit, missing post check. 
  odeqcdr::dql_update(rows = c(520367:521218), "C", "Irregular diurnal pattern. Logger likely out of water")%>% #LB
  odeqcdr::dql_update(rows = c(532723:532727, 548111:548114), "C", "Anomolous datapoint, logger likely out of water") %>%  #LB
  
  
  #'[42211-ORDEQ - 9801286 - Temperature, water]: 548673:579148
  #LB all B data. No deployment audit no post data. 
  
  
  #'[42222-ORDEQ - 10332709 - Temperature, water]: 1:32781  
  odeqcdr::dql_update(rows = c(1:3573), "E", "Data of unknown quality")%>%  #LB  
  odeqcdr::dql_update(rows = c(19031:19034), "C", "Erroneous datapoint")%>%  #LB
  odeqcdr::dql_update(rows = c(30571:32781), "C", "C audit 8/3/2021")%>%  #LB 
  odeqcdr::dql_update(rows = c(3574:30570), "B", "")%>%  #LB   
  
  
  #'[42225-ORDEQ - 10332720 - Temperature, water]: 32782:65490 
  #LB Missing deployment audit, missing post check. 
  odeqcdr::dql_update(rows = c(61650:65490), "C", "C audit 7/29/2021")%>%  #LB 
  
  
  #'[42213-ORDEQ - 10629338 - Temperature, water]: 65491:94379
  #LB missing deployment audit and post check. No audits from 2018-2019, too much time to pass as B data. 
  odeqcdr::dql_update(rows = c(65491:78422), "E", "Data of unknown quality")%>%  #LB 
  odeqcdr::dql_update(rows = c(68846, 68848, 68869:68872), "C", "Erroneous datapoint")%>%  #LB
  
  
  #'[42230-ORDEQ - 10629341 - Temperature, water]: 94380:127159
  #LB missing deployment audit and post check.
  odeqcdr::dql_update(rows = c(97096:97100), "C", "Erroneous datapoint")%>%  #LB
  
  
  #'[42203-ORDEQ - 10629346 - Temperature, water]: 127160:159436
  #LB missing deployment audit and post check.
  odeqcdr::dql_update(rows = c(128991:128995), "C", "Erroneous datapoint")%>%  #LB
  
  
  #'[42233-ORDEQ - 10753853 - Temperature, water]: 159437:192333
  #LB no pre or post data. Keeping as E. 
  
  
  #'[42231-ORDEQ - 10753854 - Temperature, water]: 192334:225113
  #LB no pre or post data. Keeping as E. 
  
  
  #'[42202-ORDEQ - 10753858 - Temperature, water]: 225114:258034
  #LB missing deployment audit and post check.
  odeqcdr::dql_update(rows = c(254198:258034), "C", "C audit 7/21/2021")%>%  #LB 
  odeqcdr::dql_update(rows = c(225114:254197), "B", "")%>%  #LB  
  
  
  #'[42234-ORDEQ - 10918629 - Temperature, water]: 258035:290955
  #LB no pre or post data. Keeping as E. 
  
  
  #'[42278-ORDEQ - 10918631 - Temperature, water]: 290956:323257
  #LB missing deployment audit and post check.
  odeqcdr::dql_update(rows = c(305039:305043), "C", "Erroneous datapoint")%>%  #LB
  
  
  #'[42209-ORDEQ - 10918633 - Temperature, water]: 323258:354142
  #LB no pre or post data. Keeping as E. 
  
  
  #'[42224-ORDEQ - 20066299 - Temperature, water]: 354143:387063
  #LB missing deployment audit and post check.
  odeqcdr::dql_update(rows = c(383228:387063), "C", "C audit 7/21/2021")%>%  #LB
  
  
  #'[42281-ORDEQ - 20066300 - Temperature, water]: 387064:419958
  #LB missing deployment audit and post check.
  odeqcdr::dql_update(rows = c(387064:416121), "B", "")%>%  #LB
  odeqcdr::dql_update(rows = c(390974:393680, 400749:401935, 408984:411614), "C", "Irregular diurnal pattern, large temperature jumps. Logger likely out of water")%>% #LB
  odeqcdr::dql_update(rows = c(416122:419958), "C", "C audit 7/21/2021")  #LB


  #'[42238-ORDEQ - 20066302 - Temperature, water]: 419959:452710
  #LB no pre or post data. Keeping as E. 
...
df4.audits.dql <- df3.audits.dql %>%
  ...
  #'[42241-ORDEQ - 9801283 - Temperature, water]: 485012:517933
  odeqcdr::dql_update(rows = c(22), "B", "") %>% #LB changed 2021-06-03 11:32 PDT E to B 
  #'[42217-ORDEQ - 9801285 - Temperature, water]: 517934:548672
  odeqcdr::dql_update(rows = c(26), "B", "") %>% #LB changed 2018-08-28 12:59 PDT C to B
  #'[42222-ORDEQ - 10332709 - Temperature, water]: 1:32781  
  odeqcdr::dql_update(rows = c(49), "B", "") %>% #LB changed 2018-07-05 14:00 PDT PDT C to B
  #'[42230-ORDEQ - 10629341 - Temperature, water]: 94380:127159
  odeqcdr::dql_update(rows = c(83, 84), "B", "") %>% #LB changed 2019-11-14 11:00 PST C to B. Logger result 2019-11-14 11:00 PST looks like it was out of water
  #'[42203-ORDEQ - 10629346 - Temperature, water]: 127160:159436
  odeqcdr::dql_update(rows = c(99), "B", "") %>% #LB changed 2021-06-07 14:47 PDT from E to B. Not sure why is was given E assignment, within B range.  
  #'[42202-ORDEQ - 10753858 - Temperature, water]: 225114:258034
  odeqcdr::dql_update(rows = c(134), "B", "") #LB changed 2021-06-03 13:53 PDT from E to B. Not sure why is was given E assignment, within B range. 
